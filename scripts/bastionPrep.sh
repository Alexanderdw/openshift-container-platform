...
subscription-manager register --force --username="$USERNAME_ORG" --password="$PASSWORD_ACT_KEY"
RETCODE=$?
...
wget --retry-connrefused --waitretry=1 --read-timeout=20 --timeout=15 -t 5 https://raw.githubusercontent.com/Alexanderdw/openshift-container-platform-playbooks/master/updateansiblecfg.yaml
